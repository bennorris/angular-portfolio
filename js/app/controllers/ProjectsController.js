function ProjectsController($scope, $location, $anchorScroll) {
  $scope.slides = [
      ...
      {image: 'img/grocery-time.png', description: 'Grocery Time', codepen: 'http://codepen.io/bennorris07/pen/BzNRyg', website: 'http://www.bennorris.co/grocery-time/',
        overview: 'A simple grocery list that has categories to prioritize what you need.', front: 'jQuery, HTML and CSS'},
      {image: 'img/tool-tracker.png', description: 'Tool Tracker', github: 'https://github.com/bennorris/tool-tracker', video: 'https://www.youtube.com/watch?v=A2Bva7B1cQo',
         ...
         front: 'HTML / ERB, CSS', back: 'Ruby, Sinatra, ActiveRecord'},
      ...
      {image: 'img/world-clock.png', description: 'World Clock', github: 'https://github.com/bennorris/world-clock', website: 'http://www.bennorris.co/world-clock/', overview: 'Local time in New York, Helsinki, Tokyo, and Wellington (a Google coder project).',
        front: 'JS, Bootstrap, HTML and CSS'
    }];
  $scope.toggleInfo = false;
  $scope.currentIndex = 0;
  $scope.showImage = true;
  $scope.bodyImage = {background: "url(" + '../img/proj.jpg' + ") no-repeat fixed center center  / cover "};
